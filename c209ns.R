...
write.csv(con, "conductance/test209ns.csv")
...
write.csv(con, "conductance/test209ns_bl.csv")
...
cond<- data.frame(read.csv("conductance/test209ns.csv"))
cond_bl<- data.frame(read.csv("conductance/test209ns_bl.csv"))
conductance<-data.frame(cond$disp, cond$Conduct, cond_bl$Conduct)
colnames(conductance)<-c('disp_dist', 'before GCB','after GCB')
write.csv(conductance, "conductance/test209ns_diff.csv")
