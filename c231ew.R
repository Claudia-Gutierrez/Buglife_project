...
st<- raster("spatialdata/stEW231.tif")
R<-1000
...
write.csv(con, "conductanceEW/test231ew.csv")
...
write.csv(con, "conductanceEW/test231ew_bl.csv")
...
cond<- data.frame(read.csv("conductanceEW/test231ew.csv"))
cond_bl<- data.frame(read.csv("conductanceEW/test231ew_bl.csv"))
conductance<-data.frame(cond$disp, cond$Conduct, cond_bl$Conduct)
colnames(conductance)<-c('disp_dist', 'before GCB','after GCB')
write.csv(conductance, "conductanceEW/test231ew_diff.csv")