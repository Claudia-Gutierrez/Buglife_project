...
write.csv(con, "conductance/test220ns.csv")
...
write.csv(con, "conductance/test220ns_bl.csv")
...
cond<- data.frame(read.csv("conductance/test220ns.csv"))
cond_bl<- data.frame(read.csv("conductance/test220ns_bl.csv"))
conductance<-data.frame(cond$disp, cond$Conduct, cond_bl$Conduct)
colnames(conductance)<-c('disp_dist', 'before GCB','after GCB')
write.csv(conductance, "conductance/test220ns_diff.csv")
