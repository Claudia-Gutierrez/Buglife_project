...
write.csv(con, "conductance/test205ns.csv")
...
write.csv(con, "conductance/test205ns_bl.csv")
...
cond<- data.frame(read.csv("conductance/test205ns.csv"))
cond_bl<- data.frame(read.csv("conductance/test205ns_bl.csv"))
conductance<-data.frame(cond$disp, cond$Conduct, cond_bl$Conduct)
colnames(conductance)<-c('disp_dist', 'before GCB','after GCB')
write.csv(conductance, "conductance/test205ns_diff.csv")
