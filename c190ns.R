...
write.csv(con, "conductance/test190ns.csv")
...
write.csv(con, "conductance/test190ns_bl.csv")
...
cond<- data.frame(read.csv("conductance/test190ns.csv"))
cond_bl<- data.frame(read.csv("conductance/test190ns_bl.csv"))
conductance<-data.frame(cond$disp, cond$Conduct, cond_bl$Conduct)
colnames(conductance)<-c('disp_dist', 'before GCB','after GCB')
write.csv(conductance, "conductance/test190ns_diff.csv")
